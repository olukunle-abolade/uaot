...
function getConnection() {
	...
	global $db_uaot_db_Url, $db_uaot_db_User, $db_uaot_db_Pass, $db_uaot_db_DbName;
	
	try {
		$dbh = new PDO("mysql:host=".$db_uaot_db_Url.";dbname=".$db_uaot_db_DbName, $db_uaot_db_User, $db_uaot_db_Pass);
